...
$('.btnGuardarConfiguracion').click(function () {
    ...
    sobre = toHTML(sobre);
    let usuario = $('.usuarioPagina').val();
    let contraseña = $('.contraseñaPagina').val();
            ...
            if (json.contador > 0) {
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        let mensaje;
                        if (respuesta === 'success') location.href = site_url;
