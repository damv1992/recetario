...
$(".text-main-1").not(".pagos").removeClass("text-main-1");
$(".pagos").addClass("text-main-1");
...
$('#idMetodoPago').hide();
$('#verImagen').hide();
if ($('#idMetodoPago').val()) $('#verImagen').show();
$('#imagenMetodoPago').change(function() {
...
$('.btnGuardarMetodoPago').click(function () {
    let id = $('#idMetodoPago').val();
    let imagen = $('#imagenMetodoPago').prop('files')[0];
    let datos = new FormData();
    datos.append('id', id);
    datos.append('imagen', imagen);
    $.ajax({
        url: site_url+'/pago/validar',
        method: 'POST',
        data: datos,
        cache: false,
        contentType: false,
...
$(".tablaMetodosPago tbody").on("click", ".btnBorrarMetodoPago", function () {
