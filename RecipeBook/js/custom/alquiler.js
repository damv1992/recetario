...
$(".text-main-1").not(".alquileres").removeClass("text-main-1");
$(".alquileres").addClass("text-main-1");
                ...
                $.ajax({
                    ...
                    success: function(respuesta) {
                        ...
                        if (respuesta === 'success')
                            setTimeout(function() {
                                location.href = site_url+'/alquiler';
                            }, 3000);
                    }
                });
            }
...
$(".tablaGenerosProducto").DataTable({
    ajax: {
        ...
        dataType: 'json',
        cache: false,
        url: site_url+'/alquiler/listarGeneros/' + producto
    },
    "pageLength" : 5,
    "responsive": true,
    "retrieve": true,
...
$('.btnGuardarGeneroProducto').click(function () {
    ...
    $.ajax({
        url: site_url+'/alquiler/validarGenero',
        method: 'POST',
        data: datos,
        cache: false,
        contentType: false,
        ...
        success: function(json) {
            ...
            if (json.contador > 0) {
                ...
                $('.form-group').removeClass('has-error');
                $.ajax({
                    url: site_url+'/alquiler/guardarGenero',
                    method: 'post',
                    data: datos,
                    cache: false,
                    contentType: false,
                    ...
                    success: function(respuesta) {
                        ...
                        if (respuesta === 'success')
                            setTimeout(function() {
                                location.href = site_url+'/alquiler/generos/' + id;
                            }, 3000);
                    }
                });
            }
...
$(".tablaGenerosProducto tbody").on("click", ".btnBorrarGeneroProducto", function () {
    ...
    Swal.fire({
        ...
        if (resultado.value) {
            $.ajax({
                url: site_url+"/alquiler/borrarGenero/" + id,
                method: "POST",
                data: datos,
                cache: false,
                contentType: false,
