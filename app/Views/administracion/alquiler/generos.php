...
<?= $this->section('contenidoMenu') ?>
    ...
    <a href="<?=site_url('alquiler/asignar/'.$producto['CodigoProducto'])?>" class="nk-btn nk-btn-rounded nk-btn-color-primary form-group">Agregar</a>
    ...
    <a href="<?=site_url('alquiler')?>" class="nk-btn nk-btn-rounded nk-btn-outline nk-btn-color-info form-group">
